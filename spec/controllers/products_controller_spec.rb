...
RSpec.describe ProductsController, type: :controller do
  before do
    @admin_user = User.create!(name: 'John1', password: 'Nonono123!', email: "admin_#{SecureRandom.uuid}@example.com", role: 'admin')
    @non_admin_user = User.create!(name: 'Steve', password: 'Yesyes321!', email: "user_#{SecureRandom.uuid}@example.com", role: 'user')
    sign_in @admin_user
  ...
  describe 'GET #index' do
    ...
    it 'filters products by category and search' do
      ...
      expect(assigns(:products).any? { |product| product.categories == 'Suplementos' && product.nombre == "Steve1" }).to be_truthy
    end
  end
