...
RSpec.describe Review, type: :model do
    before(:each) do
        ...
        @product = Product.create!(nombre: 'Pala Babolat', precio: 4000, stock: 1, user_id: @user.id, categories: 'Cancha')
        @review = Review.new(user_id: @user.id, product_id: @product.id, tittle: 'Excelente', description: 'Muy buena pala', calification: 3)
    end
