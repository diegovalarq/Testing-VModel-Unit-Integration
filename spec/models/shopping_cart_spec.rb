...
RSpec.describe ShoppingCart, type: :model do
  before(:each) do
    ...
    @product_1 = Product.create!(nombre: 'Pala Babolat', precio: 4000, stock: 1, user_id: @user.id,
                                 categories: 'Cancha')
  ...
  it 'cost envio equal to the addition of 5% of the price of each product plus 1000' do
    cost = (@product_1.precio.to_i * 0.05 * @product_1.stock.to_i) +
           (@product_2.precio.to_i * 0.05 * @product_2.stock.to_i) + 1000
